"""Create the skeletal-mesh-compatible European HGV livery material."""
import unreal

PATH = "/Game/Carla/Static/Truck/European_HGV"
NAME = "M_CarlaHGVLiveryRuntime"
...
unreal.log_warning("CARLA_HGV_LIVERY_MATERIAL_INSTALLED " + material.get_path_name())
